...
<template>
  <div class="personal">
    ...
    <div class="right" v-if="activeClass == 10">
      ...
      <div class="form">
        <el-form ref="Authform" :model="Authform" :rules="rules" label-width="120px">
          ...
          <div  :class="this.Authform.id_name !='' && this.Authform.id_no !='' && this.Authform.bank_no !='' && this.Authform.mobile !='' ? 'button' : 'buttonNo'" @click="onSubmit('Authform')">下一步</div>
          <br />
          <div
    ...
    <el-dialog title="手机验证" :visible.sync="dialogVisible" width="483px" :before-close="handleClose">
    ...
    <!-- 以下情况不支持 -->
    <el-dialog :visible.sync="dialogVisible2" width="522px" :before-close="handleClose">
      <div class="tanluang">
        <div>
          <span class="daozheng">
            <img
        ...
        <br />
        <div class="shangwei">2. 认证次数过于频繁（超过3次/天或超过2次/分钟）；</div>
        <br />
        <div class="shangwei">3. 柜台办理、电话更改预留手机号，需要过2天后才可核验；</div>
        <br />
    ...
    <!-- 友情提示 -->
    <el-dialog :visible.sync="dialogVisible3" width="522px" :before-close="handleClose">
      <div class="tanluang">
        <div>
          <span class="daozheng">
            <img
        ...
        <br />
        <div class="shangwei">1. 银行卡预留手机号和短信通知号码是不一样的，请确认手机号码为预留手机号码；</div>
        <br />
        <div class="shangwei">2. 通过电话银行、手机银行、短信通知等修改手机号可能会核验失败，建议去银行柜台修改；</div>
        <br />
        <div class="shangwei">3. 柜台办理、电话更改预留手机号，需要过2天后才可核验；</div>
        <br />
        <div style="width: 100%; text-align: right;">
    ...
    <!-- 以下场景无法支持 -->
    <el-dialog :visible.sync="dialogVisible4" width="522px" :before-close="handleClose">
      <div class="tanluang2">
        <div>
          <span class="daozheng">
            <img
        ...
        d => {
          ...
          if (d.status == 0) {
            ...
            if (sessionStorage.getItem("taskId")) {
              this.inputType = true;
              this.Authform.mobile = JSON.parse(sessionStorage.getItem("data")).agent_mobile
              this.Authform.id_name = JSON.parse(sessionStorage.getItem("data")).agent_name
            }
          } else {
            ...
            d => {
              ...
              if (d.status === 0) {
                if (d.data) {
                  ...
                  this.$router.push({ path: "/enterpriseWan" });
                }
              } else {
                this.$message.error(d.msg);
              }
